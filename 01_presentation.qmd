...
-   Depuis la plate-forme [CERISE]{.red} :
    ...
    -   https://rstudio.agriculture.gouv.fr
...
[⇒ Sur Cerise, le répertoire de travail est l'espace personnel]{.red}
...
-   → Créer un script : **Fichier \> Nouveau fichier \> Script R** (**File \> New File \> R Script**) ou :

![](img/clipboard-file1.png){fig-align="center"}

-   → Travailler avec un script existant : **Fichier \> Ouvrir un fichier**... (**File \> Open File**…) ou :

![](img/clipboard-file2.png){fig-align="center"}

-   → Sauvegarder un script : **Fichier \> Enregistrer** ou **Fichier \> Enregistrer** (**File \> Save** ou **File \> Save as**…) ou : 

![](img/clipboard-file3.png){fig-align="center"}

## Les scripts (programmes)

-   Pour exécuter des commandes d’un script, se positionner sur la ligne ou bien sélectionner l’ensemble des commandes à exécuter puis **Ctrl+Entrée** ou **Code \> Exécuter la ou les Lignes sélectionnées** (**Code \> Run Selected line(s)**) ou ![](img/clipboard-run.png)
...
1)  **Découverte de Cerise** : accéder à son répertoire personnel et créer des dossiers
